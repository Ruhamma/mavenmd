...
import { IconSearch, IconPrinter, IconCalendarCheck, IconInfoCircle } from '@tabler/icons-react';
        ...
        <div className="flex flex-col gap-4 w-full md:w-1/3">
          ...
          <div className="bg-white rounded-xl shadow p-4 relative text-sm">
            <div className="absolute top-4 right-4">
              <button
                type="button"
                className="text-primary-800  bg-[#e6e4f9] px-3 py-1 rounded text-xs hover:bg-[#dcd9f5]"
              >
                Follow Up
              </button>
            </div>
          ...
          <div className="bg-white rounded-xl shadow px-4 py-8 text-sm text-gray-800">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                <IconInfoCircle size={16} className="text-primary-800 " />
                Penicillin Allergy
              </li>
              <li className="flex items-center gap-2">
                <IconCalendarCheck size={16} className="text-primary-800 " />
                Migraine History
              </li>
              <li className="flex items-center gap-2">
                <IconCalendarCheck size={16} className="text-primary-800 " />
