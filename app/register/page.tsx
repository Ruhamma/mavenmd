                        ...
                        <section className="flex flex-col justify-center items-center gap-3 lg:gap-4 w-full max-w-sm lg:max-w-md h-full">
                            <div className="w-full flex flex-col justify-start items-start gap-1">
                                <div className="self-stretch flex flex-col justify-start items-center gap-1">
                                    <h1 className="self-stretch text-center justify-start">
                                        <span className="text-violet-950 text-xl sm:text-2xl lg:text-3xl font-semibold leading-snug">Create Account<br /></span>
                                        <span className="text-zinc-800 text-sm lg:text-md font-normal leading-snug">Fill in the details below to get started</span>
                                    </h1>
                                </div>
                            </div>
                            ...
                            <form className="w-full flex flex-col justify-start items-start gap-2 lg:gap-3 flex-1">
                                ...
                                <button
                                    type="button"
                                    onClick={handleNext}
                                    className="self-stretch h-12 px-3 py-2 bg-violet-950 rounded-[20px] outline-2 outline-offset-[-2px] outline-white inline-flex justify-center items-center"
                                >
