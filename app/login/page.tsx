        ...
        <main className="lg:h-screen lg:w-screen overflow-hidden lg:p-6">
            <div className="relative flex flex-col h-full w-full overflow-hidden">
                <header className="hidden lg:flex w-full h-24 relative overflow-hidden justify-center lg:justify-start lg:pl-8 pt-4">
                    <div className="w-28 h-10 left-[20px] top-[30px] absolute rounded-[32px] border border-violet-950" />
                    <div className="w-22 h-8 left-[40px] top-[32px] absolute justify-start">
                        <span className="text-violet-950 text-md font-normal  leading-[32px]">Maven</span>
                        <span className="text-violet-950 text-md font-bold  leading-[32px]">MD</span>
                    </div>
                </header>
                ...
                <div className="flex flex-col-reverse lg:flex-row flex-1 min-h-0">
                        ...
                        <section className="flex flex-col justify-center items-center gap-3 w-full max-w-sm lg:max-w-md flex-1">
                            <div className="w-full flex flex-col justify-start items-start gap-2">
                                <div className="self-stretch flex flex-col justify-start items-center gap-2">
                                    <h1 className="self-stretch text-center justify-start">
                                        <span className="block text-violet-950 text-2xl sm:text-3xl lg:text-3xl font-semibold  leading-snug">
                                            Welcome Back
                                        </span>
                                        <span className="text-zinc-800 text-md font-normal  leading-snug">
                                            Sign in to your Maven
                                        </span>
                                        <span className="text-violet-950 text-md font-bold  leading-snug">
                                            MD
                                        </span>
                                        <span className="text-zinc-800 text-md font-normal  leading-snug">
                                            account
                            ...
                            <form className="w-full flex flex-col justify-start items-start lg:mb-4 gap-6 lg:gap-4">
                                ...
                                <div className="self-stretch flex flex-col justify-start items-start gap-1">
                                    ...
                                    <p className="self-stretch text-center justify-start text-zinc-500 text-sm font-normal  leading-tight">It must be a combination of minimum 8 letters, numbers, and symbols.</p>
                                </div>
                                ...
                                <div className="self-stretch inline-flex justify-start items-center gap-4">
                                    <label className="flex justify-start items-center gap-2">
                                        ...
                                        />
                                        <span className="justify-start text-zinc-800 text-sm font-normal  leading-tight">Remember me</span>
                                    </label>
                                    <a href="#" className="flex-1 text-right justify-start text-Miscellaneous-Floating-Tab---Text-Unselected text-sm font-normal  leading-tight">Forgot Password?</a>
                                </div>
                                ...
                                >
                                    <div className="px-4 flex justify-center items-center gap-2.5">
                                        <span className="justify-start text-white text-base font-medium  leading-none tracking-wide">Log In</span>
                                    </div>
                                </button>
                            </form>
                            ...
                            <div className="w-full h-12 outline-1 outline-offset-[-1px] outline-white inline-flex justify-start items-start gap-4">
                                <button className="flex-1 h-10 px-3 py-4 rounded-[20px] outline-2 outline-offset-[-2px] outline-Primary-600 flex justify-center items-center">
                                    ...
                                    <div className="px-4 flex justify-center items-center gap-2.5">
                                        <span className="justify-start text-black/75 text-sm font-normal  leading-tight">Google</span>
                                    </div>
                                </button>
                                <button className="flex-1 h-10 px-3 py-4 rounded-[20px] outline-2 outline-offset-[-2px] outline-Primary-600 flex justify-center items-center">
                                    <IconBrandApple className="w-5 h-5 text-violet-950 fill-current" />
                                    <div className="px-4 flex justify-center items-center gap-2.5">
                                        <span className="justify-start text-black/75 text-sm font-normal  leading-tight">Apple</span>
                                    </div>
                                </button>
                            </div>

                            <p className="w-full text-center justify-start">
                                <span className="text-Miscellaneous-Floating-Tab---Text-Unselected text-sm font-normal  leading-tight">No account yet? </span>
                                <a href="#" className="text-Primary-700 text-sm font-normal  leading-tight">Sign Up</a>
                            </p>
                        </section>
                    </div>
                    ...
                    <aside className="w-full lg:w-[55%] lg:-mt-14 relative flex justify-center  items-center lg:px-2">
                        <div className="relative w-full max-w-[100vw]  md:max-w-[560px] lg:max-w-[640px] lg:max-h-[85vh]">
                            ...
                            <p className="absolute w-28 sm:w-32 lg:w-40 text-xs sm:text-sm font-normal text-violet-950 left-[47%] top-[5.5%]">Real Doctors</p>
                            <p className="absolute w-28 sm:w-32 lg:w-40 text-xs sm:text-sm font-bold text-violet-950 left-[50%] top-[9%]">Real Visits</p>
                            <p className="absolute w-28 sm:w-32 lg:w-40 text-xs sm:text-sm font-normal text-violet-950 left-[53%] top-[12.5%]">Real Peace of Mind</p>
                            ...
                            <p className="absolute w-48 sm:w-56 lg:w-64 text-xs font-bold text-violet-950 left-[12%] top-[77%] leading-none">
